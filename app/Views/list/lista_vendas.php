...
<div>
	<div class="botao">
		<a href="<?= empty($produtos)||empty($vendedores)||empty($clientes) ? '#' : base_url('Venda/add'); ?>" tabindex="-1">
			<button type="button" <?= empty($produtos)||empty($vendedores)||empty($clientes) ? 'class="btn btn-success" disabled' : 'class="btn btn-outline-success"' ?>>
				...
				</svg> <?= lang('list/lista_clientes.add') ?>
			</button>
		</a>
		<div class="links">
	...
	<table class="table table-hover table-bordered">
		<thead>
			<tr>
				...
				<th class="no-order"><?= lang("list/lista_vendas.del") ?></th>
			</tr>
		</thead>
		<tbody>
			...
			?>
				<tr>
					...
					<td> <?= $Venda->NOME ?> </td>
					<td>
						<a href=" <?= base_url('Venda/del/' . $Venda->ID_VENDA) ?> ">
