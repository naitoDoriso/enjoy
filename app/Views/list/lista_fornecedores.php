...
<?= $this->section('lista'); ?>
<div class="botao">
  <a href=" <?= base_url('Fornecedor/add'); ?>">
    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td><a href=" <?= base_url('Fornecedor/edit/' . $fornecedor->ID_FORNECEDOR) ?>">
          ...
          <td><a href=" <?= base_url('Fornecedor/del/' . $fornecedor->ID_FORNECEDOR) ?> " class="lixeira">
