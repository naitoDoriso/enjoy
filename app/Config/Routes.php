...
$routes->get('Venda/relatorio_mes/salvar', 'Venda::salvarRelatorio/mes');
$routes->get('Venda/relatorio_produto', 'Venda::gerarRelatorio/produto');
$routes->get('Venda/relatorio_produto/salvar', 'Venda::salvarRelatorio/produto');
$routes->get('Venda/relatorio_vendedor', 'Venda::gerarRelatorio/vendedor');
$routes->get('Venda/relatorio_vendedor/salvar', 'Venda::salvarRelatorio/vendedor');
$routes->get('/Venda/del/(:num)', 'Venda::remove/$1');
$routes->get('/Venda/edit/(:num)', 'Venda::editar/$1');
$routes->post('/Venda/edit/(:num)', 'Venda::editar/$1');
